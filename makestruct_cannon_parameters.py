...
cannon_quality = (cannon_data[1].data['flag_cannon'][object_index])
if cannon_quality > 1:
...
effective_temperature_cannon = cannon_data[1].data['Teff_cannon'][object_index]
log_surface_gravity_cannon = cannon_data[1].data['Logg_cannon'][object_index]
metalicity_cannon = cannon_data[1].data['Feh_cannon'][object_index]
microturbulence_velocity_cannon = cannon_data[1].data['Vmic_cannon'][object_index]
rotational_velocity_cannon = cannon_data[1].data['Vsini_cannon'][object_index]
...
print("Effective Temp. Surface Grav. Metalicity. Micro Turblnce. Rot Vel. Velocity. Macro Turb")
